...
if __name__ == "__main__":
    ...
    task_name = "Task177_CellPressAll"
    ...
    original_dir = r'F:\data\CellPress1338\headcut_all'
    datalist = pd.read_csv(r'F:\codes\ubuntu\nnUnet\2HeadCut_New\All_CellPressAll_info.csv')
    ...
    for i in range(len(datalist)):
        ...
        if not (all([os.path.exists(img0_path), os.path.exists(img1_path), os.path.exists(img2_path)])):
    ...
    json_dict['numTraining'] = 1186
    json_dict['numTest'] = 152
