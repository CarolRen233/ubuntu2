...
class Inferencer(_ModelCore):
    ...
    def inference(self):
        ...
        f1 = open(os.path.join(self.output_folder, 'figure7TimeSpend.txt'), 'w')
        for line in self.figure7TimeSpend_txt:
            f1.write(line + '\n')
        f1.close()
    ...
    def inference_instance(self, input_file_s, output_file):
        ...
        print ('----input_file_s:',input_file_s)
        ...
        with torch.no_grad():
            ...
            self.figure7TimeSpend_txt.append(input_instance + ' ' +
                                             'total time:' + ' ' + str(processing_time) + ' ' +
                                             'preprocess_time:' + ' ' + str(preprocess_time) + '' +
                                             'loading_time:' + ' ' + str(time_loading) + ' ' +
                                             'network time:' + ' ' + str(time_all_iters) + ' ' +
                                             'summarize_time:' + ' ' + str(summarize_time))
