...
def refine_segmentation(input_file_or_folder, output_file_or_folder, kernel_size, area_threshold, thin_threshold,
    ...
    for i, input_ins in enumerate(input_instances):
        ...
        end1 = time.time()
        figure7TimeSpend_txt.append(ins_id + ' ' + str(end1-start1))
    ...
    f1 = open(os.path.join(output_file_or_folder, 'figure7TimeSpend_refine.txt'), 'w')
    for line in figure7TimeSpend_txt:
        f1.write(line + '\n')
    f1.close()
