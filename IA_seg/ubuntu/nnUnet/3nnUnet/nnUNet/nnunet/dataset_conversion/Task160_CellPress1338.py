...
if __name__ == "__main__":
    ...
    task_name = "Task160_CellPress1338"
    ...
    original_dir = '/mnt/f/data/CellPress1338'
    datalist = pd.read_csv(join(os.path.dirname(nnUNet_raw_data), 'Task160_CellPress1338.csv'))
    print (len(datalist))
