...
if __name__ == "__main__":
    ...
    task_name = "Task153_CellPress110new"
    ...
    original_dir = '/home/ubuntu/codes/CellPress110/2headcut/CP_headcut'
    datalist = pd.read_csv('/home/ubuntu/codes/CellPress110/3nnUNet/nnUNet_output/Task153_CellPress110new.csv')
