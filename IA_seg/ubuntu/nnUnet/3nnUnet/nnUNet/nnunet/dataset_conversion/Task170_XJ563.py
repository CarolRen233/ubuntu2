...
if __name__ == "__main__":
    ...
    original_dir = '/home/ubuntu/codes/radiology/2HeadCut_New/XJ_headcut'
    datalist = pd.read_csv('/home/ubuntu/codes/radiology/3nnUnet/nnUNet_output/Task170_XJ563.csv')
    ...
    json_dict['numTraining'] = 497
    json_dict['numTest'] = 66
