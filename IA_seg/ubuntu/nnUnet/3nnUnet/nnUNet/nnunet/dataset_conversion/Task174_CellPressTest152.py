...
if __name__ == "__main__":
    ...
    task_name = "Task174_CellPressTest152"
    ...
    original_dir = '/mnt/f/data/CellPress1338/headcut'
    datalist = pd.read_csv('/mnt/f/data/CellPress1338/All_instances_info.csv')
