...
def main():
    ...
    just_head_properties_save = './after_headcut_properties_B.pkl'
    ...
    all_properties = load_pickle('./external_B_All_Data_Info.pkl')
    ...
    save_pickle(all_properties, just_head_properties_save)
    shutil.copyfile('./after_headcut_properties_B.pkl',os.path.join(args.save_dir, 'after_headcut_properties_B.pkl'))
    f1 = open('resize_B.txt', 'w')
...
def get_arguments():
    ...
    parser.add_argument('-i', '--original_dir', type=str, required=False, default='/media/ubuntu/Seagate Expansion Drive/IACTA/CellPress1338/external/B',
                        help='the folder include cta_img and ane_seg')
    parser.add_argument('-csv', '--csv', type=str, required=False, default='./external_B_All_Data_Info.csv',
                        help='ids')
    parser.add_argument('-o', '--save_dir', type=str, required=False, default='/media/ubuntu/Seagate Expansion Drive/IACTA/CellPress1338/output/ExA_Headcut',
                        help='output folder')
