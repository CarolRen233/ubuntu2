...
def main():
    ...
    all_properties = load_pickle('./All_CellPress1338_info.pkl')
    ...
    save_pickle(all_properties, just_head_properties_save)
    shutil.copyfile('./after_headcut_properties_CellPressTest.pkl',os.path.join(args.save_dir, 'after_headcut_properties_CellPressTest.pkl'))
    f1 = open('resize_CellPress.txt', 'w')
...
def get_arguments():
    ...
    parser.add_argument('-i', '--original_dir', type=str, required=False, default='/mnt/f/data/CellPress1338',
                        help='the folder include cta_img and ane_seg')
    parser.add_argument('-csv', '--csv', type=str, required=False, default='./All_CellPress1338_info.csv',
                        help='ids')
    parser.add_argument('-o', '--save_dir', type=str, required=False, default='/mnt/f/data/CellPress1338/headcut',
                        help='output folder')
