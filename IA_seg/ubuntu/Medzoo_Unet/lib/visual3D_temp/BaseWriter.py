...
dict_class_names = {"iseg2017": ["Air", "CSF", "GM", "WM"],
                    ...
                    "brats2020": ["Background", "NCR", "ED", "NET", "ET"],
                    "covid_seg": ["c1", "c2", "c3"],
                    "miccai2019": ["c1", "c2", "c3", "c4", "c5", "c6", "c7"],
                    "IACTA": ["background","IA"],
                    "CellPress": ["background","IA"]
...
class TensorboardWriter():
    ...
    def __init__(self, args,config):
        ...
        name_model = config['train']['model'] + "_" + config['data']['dataset'] + "_" + utils.datestr()
        ...
        self.classes = config['train']['classes']
        self.label_names = dict_class_names[config['data']['dataset']]
    ...
    def write_end_of_epoch(self, epoch):
        ...
        logging.info('#Train#{}'.format(train_csv_line))
        logging.info('#Valid#{}'.format(val_csv_line))