...
class UNet3D(BaseModel):
    ...
    def forward(self, x):
        ...
        #print('context_3.shape:',context_3.shape)
        if out.shape != context_3.shape:
            a = min(out.shape[0],context_3.shape[0])
            b = min(out.shape[1], context_3.shape[1])
            c = min(out.shape[2], context_3.shape[2])
            d = min(out.shape[3], context_3.shape[3])
            e = min(out.shape[4], context_3.shape[4])
            out = out[:a,:b,:c,:d,:e]
            context_3 = context_3[:a,:b,:c,:d,:e]
        ...
        if out.shape != context_2.shape:
            a = min(out.shape[0],context_2.shape[0])
            b = min(out.shape[1], context_2.shape[1])
            c = min(out.shape[2], context_2.shape[2])
            d = min(out.shape[3], context_2.shape[3])
            e = min(out.shape[4], context_2.shape[4])
            out = out[:a,:b,:c,:d,:e]
            context_2 = context_2[:a,:b,:c,:d,:e]
        ...
        if out.shape != context_1.shape:
            a = min(out.shape[0],context_1.shape[0])
            b = min(out.shape[1], context_1.shape[1])
            c = min(out.shape[2], context_1.shape[2])
            d = min(out.shape[3], context_1.shape[3])
            e = min(out.shape[4], context_1.shape[4])
            out = out[:a,:b,:c,:d,:e]
            context_1 = context_1[:a,:b,:c,:d,:e]
        ...
        if ds1_ds2_sum_upscale.shape != ds3_1x1_conv.shape:
            a = min(ds1_ds2_sum_upscale.shape[0],ds3_1x1_conv.shape[0])
            b = min(ds1_ds2_sum_upscale.shape[1], ds3_1x1_conv.shape[1])
            c = min(ds1_ds2_sum_upscale.shape[2], ds3_1x1_conv.shape[2])
            d = min(ds1_ds2_sum_upscale.shape[3], ds3_1x1_conv.shape[3])
            e = min(ds1_ds2_sum_upscale.shape[4], ds3_1x1_conv.shape[4])
            ds1_ds2_sum_upscale = ds1_ds2_sum_upscale[:a,:b,:c,:d,:e]
            ds3_1x1_conv = ds3_1x1_conv[:a,:b,:c,:d,:e]
        ...
        if ds1_ds2_sum_upscale_ds3_sum_upscale.shape != out_pred.shape:
            a = min(ds1_ds2_sum_upscale_ds3_sum_upscale.shape[0],out_pred.shape[0])
            b = min(ds1_ds2_sum_upscale_ds3_sum_upscale.shape[1], out_pred.shape[1])
            c = min(ds1_ds2_sum_upscale_ds3_sum_upscale.shape[2], out_pred.shape[2])
            d = min(ds1_ds2_sum_upscale_ds3_sum_upscale.shape[3], out_pred.shape[3])
            e = min(ds1_ds2_sum_upscale_ds3_sum_upscale.shape[4], out_pred.shape[4])
            ds1_ds2_sum_upscale_ds3_sum_upscale = ds1_ds2_sum_upscale_ds3_sum_upscale[:a,:b,:c,:d,:e]
            out_pred = out_pred[:a,:b,:c,:d,:e]
