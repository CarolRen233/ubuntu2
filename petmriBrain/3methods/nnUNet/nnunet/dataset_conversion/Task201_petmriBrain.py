...
import glob,os,sys
sys.path.append("/root/workspace/reny/petmriBrain/code/3nnUNet-master/")
import pandas as pd
...
if __name__ == "__main__":
    ...
    original_dir = '/root/workspace/reny/petmriBrain/data/petmriBrain'
    datalist = pd.read_csv('/root/workspace/reny/petmriBrain/code/0datasplit/pet_mri_Brain_info.csv')
    ...
    for i in range(len(datalist)):
        ...
        if (all([os.path.exists(img0_path),os.path.exists(img1_path),os.path.exists(seg_path)])):
            print (img0_path,img1_path,seg_path)
